...
const fromBtn = document.getElementById("openForm");
console.log(fromBtn);
const modelFrom = document.getElementById("model-main");
...
fromBtn.addEventListener("click", ()=>{
 if(modelFrom.style.display === "none"){
  modelFrom.style.display = "block";
 }else{
  modelFrom.style.display = "none";
 }
});

crossBtn.addEventListener("click" , () =>{
  if(modelFrom.style.display === "block"){
    modelFrom.style.display = "none";
  }else{
    modelFrom.style.display = "block";
  }
